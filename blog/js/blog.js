...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function sortAndPromoteArticles() {
        ...
        if (featuredTitle) {
            ...
            featuredTitle.href = newestArticle.getAttribute("data-url") || "reduce-amazon-acos.html";
        }
        if (featuredDesc) {
        ...
        if (featuredLink) {
            featuredLink.href = newestArticle.getAttribute("data-url") || "reduce-amazon-acos.html";
        }
